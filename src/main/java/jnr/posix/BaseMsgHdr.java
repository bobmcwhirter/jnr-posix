...
public abstract class BaseMsgHdr implements MsgHdr {
    ...
    protected BaseMsgHdr(NativePOSIX posix, StructLayout layout) {
        this.posix = posix;
        //this.memory = Memory.allocateDirect( posix.getRuntime(), layout.size() );
    ...
    public void setName(String name) {
        ...
        //Pointer p = Runtime.getSystemRuntime().getMemoryManager().allocateDirect(nameBytes.length);
